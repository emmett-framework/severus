...
def test_translate(T, Tpre):
    ...
    with context(Tpre):
        ...
        assert (
            Tpre('weather.cloudy.partly', lang='it') == 'nuvolosità variabile'
        )
        assert (
            Tpre('weather.cloudy.partly', lang='ru') == 'переменная облачность'
        )
...
def test_plurals(T):
    with context(T):
        assert (
            T('you received') + ' ' + T('like').format(n=1) ==
            'you received a like')
        assert (
            T('you received {}').format(T('like').format(n=1)) ==
            'you received a like')
        assert (
            T('you received', lang='it') + ' ' +
            T('like', lang='it').format(n=1) ==
            'hai ricevuto un mi piace')

        assert (
            T('you received') + ' ' + T('like').format(n=2) ==
            'you received some likes')
        assert (
            T('you received', lang='it') + ' ' +
            T('like', lang='it').format(n=2) ==
        ...
        assert (
            ...
            'you received several likes')
        assert (
            T('you received', lang='it') + ' ' +
            T('like', lang='it').format(n=10) ==
            'hai ricevuto diversi mi piace')

        assert (
            T('you received') + ' ' + T('like').format(n=20) ==
            'you received several likes')
        assert (
            T('you received', lang='it') + ' ' +
            T('like', lang='it').format(n=20) ==
            'hai ricevuto diversi mi piace')

        assert (
            T('you received') + ' ' + T('like').format(n=50) ==
            'you received a lot of likes')
        assert (
            T('you received', lang='it') + ' ' +
            T('like', lang='it').format(n=50) ==
            'hai ricevuto tantissimi mi piace')

        assert (
            T('you received') + ' ' + T('like').format(n=100) ==
            'you received a lot of likes')
        assert (
            T('you received', lang='it') + ' ' +
            T('like', lang='it').format(n=100) ==
            'hai ricevuto tantissimi mi piace')
...
def test_format(T):
    with context(T):
        ...
        assert (
            T('type {n} characters', lang='it').format(n=10) ==
            'digita 10 caratteri')
        assert T('type {n} characters') % {'n': 10} == 'type 10 characters'
        assert (
            T('type {n} characters', lang='it') % {'n': 10} ==
            'digita 10 caratteri')
        assert T('type {} characters') % (10,) == 'type 10 characters'
        assert (
            T('type {} characters', lang='it') % (10,) ==
            'digita 10 caratteri')
        assert T('type {} characters') % 10 == 'type 10 characters'
