...
def test_load(T, Tpre):
    ...
    assert set(T._languages['it']._strings.keys()) == {
        'partly cloudy', 'you received',
        'type {n} characters', 'type {} characters'
    }
    assert set(T._languages['ru']._strings.keys()) == {
        'partly cloudy'
    }
    assert set(T._languages['en']._groups.keys()) == {
        'like'
    }
    assert set(T._languages['it']._groups.keys()) == {
        'like'
    }
    ...
    assert set(Tpre._languages['en']._strings.keys()) == {
        'weather.cloudy.partly', 'like.received'
    }
    assert set(Tpre._languages['it']._strings.keys()) == {
        'weather.cloudy.partly', 'like.received'
    }
    assert set(Tpre._languages['ru']._strings.keys()) == {
        'weather.cloudy.partly'
    }
    assert set(Tpre._languages['en']._groups.keys()) == {
        'like.numerical'
    }
    assert set(Tpre._languages['it']._groups.keys()) == {
        'like.numerical'
    }
